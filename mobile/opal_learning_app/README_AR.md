...
يدخل مدير OPAL من التطبيق بنفس بيانات حساب ERP. يكتشف التطبيق `role=manager` تلقائيًا ويفتح واجهة إدارة أصلية للموبايل تشمل الملخص، الحسابات، الدورات وحالات النشر، بطاقات الاشتراك العشوائية، والتحكم في إتاحة المنصة. لا توجد كلمة مرور إدارة منفصلة للمنصة.

...
urlpatterns = [
    ...
    path("canteen/<int:pk>/safe-delete/", views.canteen_safe_delete, name="canteen_safe_delete"),
    path("monthly-report/", views.monthly_report, name="monthly_report"),
    path("consolidation-audit/", views.finance_consolidation_center, name="finance_consolidation_center"),
